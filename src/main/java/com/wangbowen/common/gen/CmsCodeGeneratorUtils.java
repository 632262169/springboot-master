 ...
 */
public class CmsCodeGeneratorUtils {
    public static String generate(String tableNames, String moduleName, String superEntity, String[] superEntityColumns) {
        ...
        try {
            ...
            AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                    // 全局配置
                    new GlobalConfig()
                            .setOutputDir("D:\\Tools\\mybatis-plus-blog\\cms")//输出目录
...
//                                    "update_date", "del_flag"})
                    ...
                    new InjectionConfig() {
                        ...
                        public String outputFile(TableInfo tableInfo) {
                            return "D:\\Tools\\mybatis-plus-blog\\cms\\xml\\" + tableInfo.getEntityName() + "Mapper.xml";
                        }
                    }))
            ).setTemplate(
...
//        //cms-日志模块
//        generate("cms_article,cms_category", "cms", "com.wangbowen.common.entity.SuperEntity");

//        generate("cms_tag,cms_article_tags", "cms");

        generate("cms_comment", "cms", "", null);
    }
}
