 ...
 */
public class LogCodeGeneratorUtils {
    public static String generate(String tableNames, String moduleName) {
        ...
        try {
            ...
            AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                    // 全局配置
                    new GlobalConfig()
                            .setOutputDir("D:\\Tools\\mybatis-plus-blog")//输出目录
                    ...
                    new DataSourceConfig()
                            ...
                            .setUsername("root")
                            .setPassword("1111")
                            .setUrl("jdbc:mysql://localhost:3306/springboot-master?useUnicode=true&characterEncoding=utf-8")
            ).setStrategy(
                    // 策略配置
                    new StrategyConfig()
...
//                                    "update_date", "del_flag"})
                    ...
                    new InjectionConfig() {
                        ...
                        public String outputFile(TableInfo tableInfo) {
                            return "D:\\Tools\\mybatis-plus-blog\\xml\\" + tableInfo.getEntityName() + "Mapper.xml";
                        }
                    }))
            ).setTemplate(
